...
tags: [typescript, cross-spawn, readline, subprocess, provider-registration, ndjson, vitest, tdd]
...
tech-stack:
  added: []
  patterns: [cross-spawn-subprocess, kill-after-result, ndjson-stdin-write, readline-stdout-parse, abort-signal-handling, startup-validation]
