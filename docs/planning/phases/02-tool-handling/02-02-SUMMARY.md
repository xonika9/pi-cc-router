...
tech-stack:
  ...
  patterns:
    [
      TrackedToolBlock discriminated union for tool_use block state,
      partial JSON accumulation with incremental parse attempts,
      raw string fallback for unparseable tool arguments,
    ]
