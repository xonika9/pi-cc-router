...
- fileURLToPath(import.meta.url) for ESM-compatible \_\_dirname resolution to find .cjs sibling
...
- Break-early pattern verified with both built-in tools and mcp**custom-tools** prefixed tools
